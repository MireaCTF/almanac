---
title: "Статический анализ и его вред на нервую систему человека"
description: ""
date: 2024-03-08
summary: "Потрошим PEшник и кракаем простой крами"  
...
![](img/sections.jpg)
Нииичосиии, 0x1b57e00 байтов это целых 28 671 488 байтов, но в десятичной! 27.34 кбайтов экзешника лежитни ни в секции кода (```.text```) или данных (```.data```), а в сеции ресурсов (```.rsrc```)!
...
Просто фоновая карнитка и не менее фоновая музыка. Ничего интересного.
...
Однако по настроящему признанными можно назвать только IDA и Ghidra, патамучта они самые мощные и практичные. Не согласны? А вот не выделяйтесь из серой массой и пользуйтесь тем же, чем и большинство.
